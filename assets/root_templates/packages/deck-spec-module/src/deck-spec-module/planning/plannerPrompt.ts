...
function buildPlannerPrompt(input: {
	...
	return [
		...
		"- Every `image_prompt_spec.avoid_elements` array must contain concrete deck-safety exclusions. Never leave it empty, including for icon or diagram assets.",
		"- Use at least three avoid-elements whenever you define an image prompt spec, and always include deck-safe exclusions such as logos, tiny unreadable text, UI chrome, or watermarks.",
		"- Avoid placeholder copy, TODO text, and thin one-line narrative content except for intentional short-form labels.",
		"- Non-shortform plain-text assets such as hero messages, callouts, card bodies, timeline bodies, and closing statements must read like deck-ready sentences, not terse fragments.",
