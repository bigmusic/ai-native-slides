...
- [ ] 2026-04-01 11:51 PDT: still need to finish the fresh rerun through `pnpm spec`, second-stage project authoring, deterministic validation, and final bug triage before deciding whether the surfaced issue is a reusable skill regression or only deck-specific content/layout drift.
